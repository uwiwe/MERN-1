            ...
            <div class="bg-gradient-to-b from-white to-purple-200">
                ...
                <div class="grid grid-cols-2 mt-12">
                    <div class="flex items-center justify-center flex-col">
                        ...
                        <input class="text-center border-gray-500 lg:border-2 lg:pl-40 lg:pr-40 lg:pt-1 lg:pb-1 lg:mb-24 lg:mt-3.5" placeholder="Ex. 31190468" type="text"/>
                        <p class="text-center text-purple-700 font-semibold lg:text-3xl">Has spent ($)</p>
                        <input class="text-center border-gray-500 lg:border-2 lg:pl-40 lg:pr-40 lg:pt-1 lg:pb-1 lg:mb-24 lg:mt-3.5" placeholder="Ex. 2,089.00" type="text"/>
                    ...
                    <div class="flex items-center justify-center flex-col grid grid-cols-3 pb-80">
                        <p class="text-center text-purple-700 font-semibold lg:text-2xl"> Full Name</p>
